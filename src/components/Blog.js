              ...
              <Link to={{ pathname: "/sideblog", state: "61d674bf8321960131363f03" }}>
                <div className="trand-right-single d-flex">
                  <div className="trend-bottom-img mb-30">
                    <img src="https://miro.medium.com/max/1024/1*4yeTXY-vKnoCZ0nlU9NFPA.png" alt="" style={{ width: "100%" }} />
                  </div>
                  <div className="trand-right-cap">
                    <span className="color1 mx-md-3">Internship</span>
                    <h4 className=" mx-md-3">Software Development Engineer - Intern (Amazon WoW Applications)</h4>
                  </div>
                </div>
              </Link>
              <hr></hr>
              <Link to={{ pathname: "/sideblog", state: "61d2ff32ecee6a01778744f7" }}>
                <div className="trand-right-single d-flex">
                  ...
                  <div className="trand-right-cap">
                    <span className="color1 mx-md-3">Internship</span>
                    <h4 className=" mx-md-3">Reactjs development work from home JOB/INTERNSHIP</h4>
                  </div>
                </div>
              </Link>
            </div>
