                        ...
                        <div className="course-block">
                          ...
                          <div className="course-block-footer-treatment">
                            <div className="duration-view">
                              Duration:
                              <span style={{ fontWeight: 500 }}>3 weeks</span>
                            </div>
                                ...
                                >
                                  <span className="hover hover-1 line-span">
                                    <Link
                                      ...
                                      onClick={(event) =>
                                        select_project_handler(event, "Nodejs", "web development project with HTML and CSS", "3 weeks", "entry level")
                                      }
                                    >
                                      Apply
                                    </Link>
                                ...
                                >
                                  <span className="hover hover-1 line-span">
                                    <Link
                                      ...
                                      className="btn btn-outline-light my-2 my-sm-0 mr-3 text-uppercase"
                                      style={{ color: "blue" }}
                                      onClick={(event) => select_project_handler(event, "Java", "Core Java-Awt,Swings,JDBC,Mysql", "3 weeks", "entry level")}
                                    >
                                      Apply
                                    </Link>
                                  </span>
                                    ...
                                    <Link
                                      ...
                                      onClick={(event) =>
                                        select_project_handler(
                                          event,
                                          "Python",
                                          "web development project with python and HTML and CSS",
                                          "3 weeks",
                                          "entry level"
                                        )
                                      }
                                ...
                                >
                                  <span className="hover hover-1 line-span">
                                    <Link
                                      ...
                                      className="btn btn-outline-light my-2 my-sm-0 mr-3 text-uppercase"
                                      style={{ color: "blue" }}
                                      onClick={(event) => select_project_handler(event, "Android project", "xml,json,java,mysql", "3 weeks", "entry level")}
                                    >
                                      Apply
                                    </Link>
                                  </span>
                                ...
                                >
                                  <span className="hover hover-1 line-span">
                                    <Link
                                      ...
                                      className="btn btn-outline-light my-2 my-sm-0 mr-3 text-uppercase"
                                      style={{ color: "blue" }}
                                      onClick={(event) => select_project_handler(event, "Reactjs", "Html,CSS,JS,JSX, reactjs", "3 weeks", "entry level")}
                                    >
                                      Apply
                                    </Link>
                                  </span>
                                ...
                                >
                                  <span className="hover hover-1 line-span">
                                    <Link
                                      ...
                                      className="btn btn-outline-light my-2 my-sm-0 mr-3 text-uppercase"
                                      style={{ color: "blue" }}
                                      onClick={(event) => select_project_handler(event, "Angularjs", "Html,CSS,JS,angularjs", "3 weeks", "entry level")}
                                    >
                                      Apply
                                    </Link>
                                  </span>
                                ...
                                >
                                  <span className="hover hover-1 line-span">
                                    <Link
                                      ...
                                      className="btn btn-outline-light my-2 my-sm-0 mr-3 text-uppercase"
                                      style={{ color: "blue" }}
                                      onClick={(event) => select_project_handler(event, "PHP", "Html,CSS,JS,Mysql", "3 weeks", "entry level")}
                                    >
                                      Apply
                                    </Link>
                                  </span>
                                ...
                                >
                                  <span className="hover hover-1 line-span">
                                    <Link
                                      ...
                                      className="btn btn-outline-light my-2 my-sm-0 mr-3 text-uppercase"
                                      style={{ color: "blue" }}
                                      onClick={(event) => select_project_handler(event, "Reactjs", "SQL Database project", "3 weeks", "entry level")}
                                    >
                                      Apply
                                    </Link>
                                  </span>
                                ...
                                >
                                  <span className="hover hover-1 line-span">
                                    <Link
                                      ...
                                      className="btn btn-outline-light my-2 my-sm-0 mr-3 text-uppercase"
                                      style={{ color: "blue" }}
                                      onClick={(event) => select_project_handler(event, "C++ project", "c/c++ language", "4 weeks", "intermediate level")}
                                    >
                                      Apply
                                    </Link>
                                  </span>
                                ...
                                >
                                  <span className="hover hover-1 line-span">
                                    <Link
                                      ...
                                      style={{ color: "blue" }}
                                      onClick={(event) =>
                                        select_project_handler(event, "IOS project", "FLutter, Kotlin, React Native", "4 weeks", "intermediate level")
                                      }
                                    >
                                      Apply
                                    </Link>
                                ...
                                >
                                  <span className="hover hover-1 line-span">
                                    <Link
                                      ...
                                      style={{ color: "blue" }}
                                      onClick={(event) =>
                                        select_project_handler(event, "App development", "Java, SQLite(basic DBMS queries)", "4 weeks", "intermediate level")
                                      }
                                    >
                                      Apply
                                    </Link>
                                ...
                                >
                                  <span className="hover hover-1 line-span">
                                    <Link
                                      ...
                                      className="btn btn-outline-light my-2 my-sm-0 mr-3 text-uppercase"
                                      style={{ color: "blue" }}
                                      onClick={(event) => select_project_handler(event, "Android Project", "Java, SqLite", "4 weeks", "intermediate level")}
                                    >
                                      Apply
                                    </Link>
                                  </span>
                                ...
                                >
                                  <span className="hover hover-1 line-span">
                                    <Link
                                      ...
                                      style={{ color: "blue" }}
                                      onClick={(event) =>
                                        select_project_handler(event, "Python project", "HTML,CSS,JavaScript,Python,Flask", "4 weeks", "intermediate level")
                                      }
                                    >
                                      Apply
                                    </Link>
                                ...
                                >
                                  <span className="hover hover-1 line-span">
                                    <Link
                                      ...
                                      style={{ color: "blue" }}
                                      onClick={(event) =>
                                        select_project_handler(event, "Java Project", "Java Basics, Android basics", "4 weeks", "intermediate level")
                                      }
                                    >
                                      Apply
                                    </Link>
                      ...
                      <div className="course-card" style={{ margin: "22px 8px" }}>
                        ...
                        <div className="course-block">
                          ...
                          <div className="course-block-footer-treatment">
                            <div className="duration-view">
                              Duration:
                              <span style={{ fontWeight: 500 }}>5 weeks</span>
                            </div>
                            <div className="know-more-button">
                              <div className="underline-animate">
                                <div
                                ...
                                >
                                  <span className="hover hover-1 line-span">
                                    <Link
                                      ...
                                      style={{ color: "blue" }}
                                      onClick={(event) =>
                                        select_project_handler(event, "Machine Leanring Project", "Python, API, Chatbot", "5 weeks", "Difficult level")
                                      }
                                    >
                                      Apply
                                    </Link>
                                    ...
                                    <Link
                                      ...
                                      onClick={(event) =>
                                        select_project_handler(
                                          event,
                                          "Ruby Project",
                                          "JavaScript, PHP, Java, Node.Js, Vue,Python",
                                          "5 weeks",
                                          "Difficult level"
                                        )
                                      }
                                ...
                                >
                                  <span className="hover hover-1 line-span">
                                    <Link
                                      ...
                                      className="btn btn-outline-light my-2 my-sm-0 mr-3 text-uppercase"
                                      style={{ color: "blue" }}
                                      onClick={(event) => select_project_handler(event, "Cloud Project", "Git, Any programming", "5 weeks", "Difficult level")}
                                    >
                                      Apply
                                    </Link>
                                  </span>
